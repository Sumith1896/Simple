...
CSpriteManager *CSpriteManager::m_pInstance = NULL;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::InitSpriteManager(IDirect3DDevice9 *d3dDevice, ID3DXSprite *d3dSprite)
{
...
//
//////////////////////////////////////////////////////////////////////////
int CSpriteManager::LoadSprite(const int &nTexture, bool bStatic)
{
	//create a new sprite
	...
	m_pTextureManager->GetTexture(nTexture)->GetLevelDesc(0, &d3dsd);
...
//
//////////////////////////////////////////////////////////////////////////
int CSpriteManager::LoadSprite(const char *szFileName, bool bStatic)
{
	//create a new sprite
	tSprite *pSprite = new tSprite;
	...
	//get texture surface description
	m_pTextureManager->GetTexture(pSprite->nTexture)->GetLevelDesc(0, &d3dsd);
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::DrawSprite(const unsigned int &nSpriteID)
{
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::DrawSprite(const unsigned int &nSpriteID, const D3DXCOLOR &d3dColor)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::DrawSprite(const unsigned int &nSpriteID, const RECT &spriteRect, const D3DXCOLOR &d3dColor)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::RotateSprite(const unsigned int &nSpriteID, const float &fRotate)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::ScaleSprite(const unsigned int &nSpriteID, const float &fScaleWidth, const float &fScaleHeight)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::TranslateSprite(const unsigned int &nSpriteID, const float &fPositionX, const float &fPositionY)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
int CSpriteManager::GetWidth(const unsigned int &nSpriteID)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return 0;
...
//
//////////////////////////////////////////////////////////////////////////
int CSpriteManager::GetHeight(const unsigned int &nSpriteID)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return 0;
...
//
//////////////////////////////////////////////////////////////////////////
D3DXVECTOR3 CSpriteManager::GetCenter(const unsigned int &nSpriteID)
{
	D3DXVECTOR3 temp;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::SetCenter(const unsigned int &nSpriteID, const float &fCenterX, const float &fCenterY)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::SetColor(const unsigned int &nSpriteID, const float &fColorRed, const float &fColorGreen, const float &fColorBlue, const float &fColorAlpha)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::SetMatrix(const unsigned int &nSpriteID, D3DXMATRIX d3dMat)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
...
//
//////////////////////////////////////////////////////////////////////////
D3DXMATRIX CSpriteManager::GetMatrix(const unsigned int &nSpriteID)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
	{
...
//
//////////////////////////////////////////////////////////////////////////
void CSpriteManager::UnloadSprite(const unsigned int &nSpriteID)
{
	//check if the index is out of the array bounds
	if(nSpriteID > (m_vSprites.size() - 1) || !m_vSprites[nSpriteID])
		return;
